...
def _analytics_row(
    *,
    ...
    return {
        ...
        "ask": ask,
        "mid": mid,
        "last": option_tick.get("last"),
        "bid_size": option_tick.get("bid_size"),
        "ask_size": option_tick.get("ask_size"),
        "volume": option_tick.get("volume"),
        ...
        "ibkr_delta": option_tick.get("ibkr_delta"),
        "ibkr_gamma": option_tick.get("ibkr_gamma"),
        "ibkr_vega": option_tick.get("ibkr_vega"),
        "ibkr_theta": option_tick.get("ibkr_theta"),
        "ibkr_vanna": None,
